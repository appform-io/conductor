...
public class StoredStringAttributeValue extends StoredAttributeValue {
    @Serial
    private static final long serialVersionUID = -8539400713265025782L;

    @Column(name = "text_value")
    private String textValue;

    public StoredStringAttributeValue() {
