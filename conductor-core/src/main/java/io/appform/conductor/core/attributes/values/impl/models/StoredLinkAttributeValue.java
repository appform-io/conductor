...
public class StoredLinkAttributeValue extends StoredAttributeValue {
    @Serial
    private static final long serialVersionUID = -7167035710598991041L;
    ...
    public StoredLinkAttributeValue() {
