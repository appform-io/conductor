...
@SQLDelete(sql = "update attribute_definitions set deleted=true where attribute_def_id=?")
public abstract class StoredAttributeDefinition implements Serializable {
    public static final String ATTRIBUTE_DEFINITIONS_TABLE = "attribute_definitions";

    @Serial
    private static final long serialVersionUID = -3178859801624436392L;

    @Id
    @Column(name = "attribute_def_id")
    private String id;
    ...
    public abstract <T> T accept(final StoredAttributeDefinitionVisitor<T> visitor);
}
