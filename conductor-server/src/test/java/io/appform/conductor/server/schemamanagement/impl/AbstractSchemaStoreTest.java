 ...
 *
 */
abstract class AbstractSchemaStoreTest {
    ...
    void test(SchemaStore store) {
        ...
        assertNotNull(store.addField(sId, ConductorServerUtils.readableId(sId, "f6"), new ChoiceFieldSchema("f6",
                                                                                                            ...
                                                                                                            new Date(),
                                                                                                            new Date(),
                                                                                                            List.of(new ChoiceFieldSchema.Option(
                                                                                                                            "cat",
                                                                                                                            "Cat"),
                                                                                                                    new ChoiceFieldSchema.Option(
                                                                                                                            "dog",
                                                                                                                            "Dog")),
                                                                                                            "cat"))
                              .orElse(null));
        ...
        assertEquals(ConductorServerUtils.readableId(schemaSummary.getId(), "f1"), schema.getFields().get(0).getId());
        ...
        assertEquals("Default String FieldValue",
                     stringFieldSchema.setDefaultValue("Default String FieldValue").getDefaultValue());
        /* ******* String field tests end ****** */

        /* ******* Boolean field tests start ****** */
        assertEquals(FieldType.BOOLEAN, schema.getFields().get(1).getType());
        assertEquals(ConductorServerUtils.readableId(schemaSummary.getId(), "f2"), schema.getFields().get(1).getId());
        ...
        assertEquals(ConductorServerUtils.readableId(schemaSummary.getId(), "f3"), schema.getFields().get(2).getId());
        ...
        assertEquals(ConductorServerUtils.readableId(schemaSummary.getId(), "f4"), schema.getFields().get(3).getId());
        ...
        assertEquals(ConductorServerUtils.readableId(schemaSummary.getId(), "f5"), schema.getFields().get(4).getId());
        ...
        assertEquals(ConductorServerUtils.readableId(schemaSummary.getId(), "f6"), schema.getFields().get(5).getId());
        ...
        assertEquals("Changed",
                     store.updateDescription(sId, "Changed").map(Schema::getDescription).orElse(null));
        ...
        assertEquals("Changed", store.updateField(sId,
                ...
                .orElse(null));
        assertEquals("Changed", store.updateField(sId,
                                                  ConductorServerUtils.readableId(sId, "f3"),
                                                  schema.getFields().get(2).setDescription("Changed"))
                .map(FieldSchema::getDescription)
                .orElse(null));
        assertEquals("Changed", store.updateField(sId,
                                                  ConductorServerUtils.readableId(sId, "f4"),
                                                  schema.getFields().get(3).setDescription("Changed"))
                .map(FieldSchema::getDescription)
                .orElse(null));
        assertEquals("Changed", store.updateField(sId,
                                                  ConductorServerUtils.readableId(sId, "f5"),
                                                  schema.getFields().get(4).setDescription("Changed"))
                .map(FieldSchema::getDescription)
                .orElse(null));
        assertEquals("Changed", store.updateField(sId,
                                                  ConductorServerUtils.readableId(sId, "f6"),
                                                  schema.getFields().get(5).setDescription("Changed"))
                .map(FieldSchema::getDescription)
                .orElse(null));
    ...
    void testFieldCreateOrUpdate(SchemaStore store) {
        val schemaSummary = store.create("Test", "Test Schema").orElse(null);
        assertNotNull(schemaSummary);
        val sId = schemaSummary.getId();
        assertEquals(schemaSummary, store.read(sId).orElse(null));
    ...
    void testExceptionStoreCreateFail(SchemaStore store) {
    ...
    void testExceptionsOutOfBound(SchemaStore store) {
    ...
    void testExceptionsUpdateDescriptionNullParams(SchemaStore store) {
    ...
    void testExceptionsUpdateStateNullParams(SchemaStore store) {
    ...
    void testExceptionsAddFieldNullParams(SchemaStore store) {
    ...
    void testExceptionsGetFieldNullParams(SchemaStore store) {
    ...
    void testExceptionsUpdateFieldNullParams(SchemaStore store) {
    ...
    void testExceptionsDeleteFieldNullParams(SchemaStore store) {
    ...
    void testExceptions(SchemaStore store) {
        try {
            store.deleteField(null, null);
            fail("Exception didn't occur - test failed");
        }
