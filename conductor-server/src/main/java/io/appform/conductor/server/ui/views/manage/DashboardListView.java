...
public class DashboardListView extends BaseLoggedInView {
    List<Dashboard> dashboards;

    public DashboardListView(User currentUser, List<Dashboard> dashboards) {
        super("templates/dashboard/dashboards-list.hbs",
              currentUser,
