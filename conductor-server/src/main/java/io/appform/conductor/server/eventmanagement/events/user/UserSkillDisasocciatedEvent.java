...
package io.appform.conductor.server.eventmanagement.events.user;
...
@EventSubType(EventType.USER_SKILL_DISACCOSIATED)
@SuperBuilder
@Jacksonized
public class UserSkillDisasocciatedEvent extends Event {
    String skillId;
    String skillValueId;

    public UserSkillDisasocciatedEvent(String skillId, String skillValueId, String userId) {
        super(EventType.USER_SKILL_DISACCOSIATED, ReferredObjectType.USER, userId);
