...
@EventSubType(EventType.USER_STATE_CHANGED)
@SuperBuilder
@Jacksonized
public class UserStateChangeEvent extends Event {
    ...
    public UserStateChangeEvent(String userId, UserState state) {
        super(EventType.USER_STATE_CHANGED, ReferredObjectType.USER, userId);
        this.state = state;
    }
