...
@EventSubType(EventType.USER_SKILL_ASSOCIATED)
@SuperBuilder
@Jacksonized
public class UserSkillAssociatedEvent extends Event {
    String skillId;
    String skillValueId;

    public UserSkillAssociatedEvent(String skillId, String skillValueId, String userId) {
        super(EventType.USER_SKILL_ASSOCIATED, ReferredObjectType.USER, userId);
