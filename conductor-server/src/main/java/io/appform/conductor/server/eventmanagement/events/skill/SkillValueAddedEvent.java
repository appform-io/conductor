...
@EventSubType(EventType.SKILL_VALUE_ADDED)
@SuperBuilder
@Jacksonized
public class SkillValueAddedEvent extends Event {
    String skillValueId;

    public SkillValueAddedEvent(String skillId, String skillValueId) {
        super(EventType.SKILL_VALUE_ADDED, ReferredObjectType.SKILL, skillId);
