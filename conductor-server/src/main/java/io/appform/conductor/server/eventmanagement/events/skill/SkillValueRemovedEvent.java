...
package io.appform.conductor.server.eventmanagement.events.skill;
...
@EventSubType(EventType.SKILL_VALUE_REMOVED)
@SuperBuilder
@Jacksonized
public class SkillValueRemovedEvent extends Event {
    String skillValueId;

    public SkillValueRemovedEvent(String skillId, String skillValueId) {
        super(EventType.SKILL_VALUE_REMOVED, ReferredObjectType.SKILL, skillId);
