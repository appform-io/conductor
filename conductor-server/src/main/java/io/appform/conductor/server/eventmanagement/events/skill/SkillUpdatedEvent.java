...
@EventSubType(EventType.SKILL_UPDATED)
@SuperBuilder
@Jacksonized
public class SkillUpdatedEvent extends Event {

    public SkillUpdatedEvent(String skillId) {
        super(EventType.SKILL_UPDATED, ReferredObjectType.SKILL, skillId);
    }
