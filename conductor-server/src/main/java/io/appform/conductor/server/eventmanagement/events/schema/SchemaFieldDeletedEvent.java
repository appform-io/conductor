...
@EventSubType(EventType.SCHEMA_FIELD_DELETED)
@SuperBuilder
@Jacksonized
public class SchemaFieldDeletedEvent extends Event {
    String fieldId;

    public SchemaFieldDeletedEvent(String schemaId, String fieldId) {
        super(EventType.SCHEMA_FIELD_DELETED, ReferredObjectType.SCHEMA, schemaId);
