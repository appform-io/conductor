...
@EventSubType(EventType.USER_GROUP_ASSIGNED)
@SuperBuilder
@Jacksonized
public class UserGroupAssignedEvent extends Event {
    String groupId;

    public UserGroupAssignedEvent(String groupId, String userId) {
        super(EventType.USER_GROUP_ASSIGNED, ReferredObjectType.USER, userId);
