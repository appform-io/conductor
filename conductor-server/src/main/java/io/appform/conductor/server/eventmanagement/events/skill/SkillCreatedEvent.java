...
@EventSubType(EventType.SKILL_CREATED)
@SuperBuilder
@Jacksonized
public class SkillCreatedEvent extends Event {

    public SkillCreatedEvent(String skillId) {
        super(EventType.SKILL_CREATED, ReferredObjectType.SKILL, skillId);
    }
