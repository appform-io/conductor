...
package io.appform.conductor.server.eventmanagement.events.group;
...
@EventSubType(EventType.GROUP_DELETED)
@SuperBuilder
@Jacksonized
public class GroupDeletedEvent extends Event {

    public GroupDeletedEvent(String groupId) {
        super(EventType.GROUP_DELETED, ReferredObjectType.GROUP, groupId);
    }
