...
@EventSubType(EventType.USER_ROLE_ASSIGNED)
@SuperBuilder
@Jacksonized
public class UserRoleAssignedEvent extends Event {
    String roleId;

    public UserRoleAssignedEvent(String userId, String roleId) {
        super(EventType.USER_ROLE_ASSIGNED, ReferredObjectType.USER, userId);
        this.roleId = roleId;
    }
