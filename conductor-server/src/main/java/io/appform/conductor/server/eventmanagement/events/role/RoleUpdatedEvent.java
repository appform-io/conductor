...
package io.appform.conductor.server.eventmanagement.events.role;
...
@EventSubType(EventType.ROLE_UPDATED)
@SuperBuilder
@Jacksonized
public class RoleUpdatedEvent extends Event {

    public RoleUpdatedEvent(String id) {
        super(EventType.ROLE_UPDATED, ReferredObjectType.ROLE, id);
    }
