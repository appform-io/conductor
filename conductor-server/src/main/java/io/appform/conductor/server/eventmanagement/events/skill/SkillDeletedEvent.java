...
@EventSubType(EventType.SKILL_DELETED)
@SuperBuilder
@Jacksonized
public class SkillDeletedEvent extends Event {

    public SkillDeletedEvent(String skillId) {
        super(EventType.SKILL_DELETED, ReferredObjectType.SKILL, skillId);
    }
