...
@EventSubType(EventType.SCHEMA_FIELD_UPDATED)
@SuperBuilder
@Jacksonized
public class SchemaFieldUpdatedEvent extends Event {
    String fieldId;

    public SchemaFieldUpdatedEvent(String schemaId, String fieldId) {
        super(EventType.SCHEMA_FIELD_UPDATED, ReferredObjectType.SCHEMA, schemaId);
