...
public class TicketFieldEquals extends TicketFieldFilter {
    Object value;
    @Jacksonized
    @Builder
    public TicketFieldEquals(String fieldSchemaId, Object value) {
        super(TicketFieldFilterType.EQUALS, fieldSchemaId);
        this.value = value;
    }
