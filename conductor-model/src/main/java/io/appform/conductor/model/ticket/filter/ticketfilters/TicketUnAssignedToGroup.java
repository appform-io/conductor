...
/**
 * Filter to match all tickets unassigned to any group
 */
@Value
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class TicketUnAssignedToGroup extends TicketFilter {

    @Builder
    @Jacksonized
    public TicketUnAssignedToGroup() {
        super(TicketFilterType.UNASSIGNED_TO_GROUP);
    }
