...
@EventSubType(EventType.WORKFLOW_UPDATED)
@SuperBuilder
@Jacksonized
public class WorkflowUpdatedEvent extends Event {

    public WorkflowUpdatedEvent(String workflowId) {
        super(EventType.WORKFLOW_UPDATED, ReferredObjectType.WORKFLOW, workflowId);
    }
