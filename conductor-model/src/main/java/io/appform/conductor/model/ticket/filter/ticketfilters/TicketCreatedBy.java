...
/**
 * Filter to match all tickets created by given group id
 */
@Value
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class TicketCreatedBy extends TicketFilter {
    String createByUserId;

    @Builder
    @Jacksonized
    public TicketCreatedBy(String createByUserId) {
        super(TicketFilterType.CREATED_BY);
