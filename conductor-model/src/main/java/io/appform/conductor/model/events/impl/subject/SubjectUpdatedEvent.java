...
@EventSubType(EventType.SUBJECT_UPDATED)
@SuperBuilder
@Jacksonized
public class SubjectUpdatedEvent extends Event {

    public SubjectUpdatedEvent(String globalSubjectId) {
        super(EventType.SUBJECT_UPDATED, ReferredObjectType.SUBJECT, globalSubjectId);
    }
