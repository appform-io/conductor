...
/**
 * Filter to match all tickets for given workflow
 */
@Value
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class TicketWorkflowEquals extends TicketFilter {
    String workflowId;

    @Builder
    @Jacksonized
    public TicketWorkflowEquals(String workflowId) {
        super(TicketFilterType.WORKFLOW_EQUALS);
