...
public class TicketFieldContainsChoices extends TicketFieldFilter {
    List<String> choices;
    @Jacksonized
    @Builder
    public TicketFieldContainsChoices(String fieldSchemaId, @Singular List<String> choices) {
        super(TicketFieldFilterType.CONTAINS_CHOICES, fieldSchemaId);
