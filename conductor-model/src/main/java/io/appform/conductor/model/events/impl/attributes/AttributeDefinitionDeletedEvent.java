...
@EventSubType(EventType.ATTRIBUTE_DEFINITION_DELETED)
@SuperBuilder
@Jacksonized
public class AttributeDefinitionDeletedEvent extends Event {

    AttributeScopeType scopeType;

    public AttributeDefinitionDeletedEvent(String attributeDefinitionId, AttributeScopeType scopeType) {
        super(EventType.ATTRIBUTE_DEFINITION_DELETED, ReferredObjectType.ATTRIBUTE_DEFINITION, attributeDefinitionId);
