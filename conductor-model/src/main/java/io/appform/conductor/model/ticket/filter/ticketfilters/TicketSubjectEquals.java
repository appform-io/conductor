...
/**
 * Filter to match all tickets for given subject
 */
@Value
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class TicketSubjectEquals extends TicketFilter {
    String subjectId;

    @Builder
    @Jacksonized
    public TicketSubjectEquals(String subjectId) {
        super(TicketFilterType.SUBJECT_EQUALS);
