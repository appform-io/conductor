...
public class TicketsUpdatedTimeWindow extends TicketFilter {
    Duration duration;
    Date from;
    @Builder
    @Jacksonized
    public TicketsUpdatedTimeWindow(Duration duration, Date from) {
        super(TicketFilterType.UPDATED_TIME_WINDOW);
