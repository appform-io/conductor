...
public class LinkAttributeDefinition extends AttributeDefinition {
    ...
    public LinkAttributeDefinition(
            ...
            Date created,
            Date updated) {
        super(AttributeType.LINK, id, name, displayName, description, created, updated);
    }
    ...
    @Override
    public LinkAttributeDefinition withDisplayName(String displayName) {
        return new LinkAttributeDefinition(getId(),
                                           getName(),
                                           displayName,
                                           getDescription(),
                                           getCreated(),
