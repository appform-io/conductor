...
@EventSubType(EventType.ADDRESS_UPDATED)
@SuperBuilder
@Jacksonized
public class AddressUpdatedEvent extends Event {
    ...
    @Builder
    public AddressUpdatedEvent(String globalSubjectId, String addressId) {
        super(EventType.ADDRESS_UPDATED, ReferredObjectType.SUBJECT, globalSubjectId);
