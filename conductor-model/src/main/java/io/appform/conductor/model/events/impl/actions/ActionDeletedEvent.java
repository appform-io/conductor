...
package io.appform.conductor.model.events.impl.actions;
...
@EventSubType(EventType.ACTION_DELETED)
@SuperBuilder
@Jacksonized
public class ActionDeletedEvent extends Event {

    public ActionDeletedEvent(String actionId) {
        super(EventType.ACTION_DELETED, ReferredObjectType.ACTION, actionId);
    }
