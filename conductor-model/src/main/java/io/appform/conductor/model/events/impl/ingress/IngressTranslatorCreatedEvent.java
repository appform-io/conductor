...
@EventSubType(EventType.INGRESS_TRANSLATOR_CREATED)
@SuperBuilder
@Jacksonized
public class IngressTranslatorCreatedEvent extends Event {

    public IngressTranslatorCreatedEvent(String id) {
        super(EventType.INGRESS_TRANSLATOR_CREATED, ReferredObjectType.INGRESS_TRANSLATOR, id);
    }
