...
/**
 * Filter to match all tickets unassigned to any user
 */
@Value
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class TicketUnAssignedToUser extends TicketFilter {

    @Builder
    @Jacksonized
    public TicketUnAssignedToUser() {
        super(TicketFilterType.UNASSIGNED_TO_USER);
    }
