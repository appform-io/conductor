...
@EventSubType(EventType.COMMENT_ADDED)
@SuperBuilder
@Jacksonized
public class CommentAddedEvent extends Event {
    String commentId;

    public CommentAddedEvent(String ticketId, String commentId) {
        super(EventType.COMMENT_ADDED, ReferredObjectType.TICKET, ticketId);
