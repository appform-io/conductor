...
@EventSubType(EventType.WORKFLOW_DELETED)
@SuperBuilder
@Jacksonized
public class WorkflowDeletedEvent extends Event {

    public WorkflowDeletedEvent(String workflowId) {
        super(EventType.WORKFLOW_DELETED, ReferredObjectType.WORKFLOW, workflowId);
    }
