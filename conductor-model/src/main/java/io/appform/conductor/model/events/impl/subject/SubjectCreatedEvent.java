...
@EventSubType(EventType.SUBJECT_CREATED)
@SuperBuilder
@Jacksonized
public class SubjectCreatedEvent extends Event {

    public SubjectCreatedEvent(String globalSubjectId) {
        super(EventType.SUBJECT_CREATED, ReferredObjectType.SUBJECT, globalSubjectId);
    }
