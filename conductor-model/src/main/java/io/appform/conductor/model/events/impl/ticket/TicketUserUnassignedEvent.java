...
@SuperBuilder
@Jacksonized
public class TicketUserUnassignedEvent extends Event {

    public TicketUserUnassignedEvent(String ticketId) {
        super(EventType.TICKET_USER_UNASSIGNED, ReferredObjectType.TICKET, ticketId);
    }
