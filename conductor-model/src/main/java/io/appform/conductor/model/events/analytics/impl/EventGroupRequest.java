...
/**
 * Group events by type or time
 */
@Value
@EqualsAndHashCode(callSuper = true)
@ToString(callSuper = true)
public class EventGroupRequest extends EventQueryRequest {

    List<GroupingElement> groupingElements;

    @Jacksonized
    @Builder
    public EventGroupRequest(String requestId, EventFilters filters, List<GroupingElement> groupingElements) {
        super(EventQueryOpCode.GROUP_BY, requestId, filters);
