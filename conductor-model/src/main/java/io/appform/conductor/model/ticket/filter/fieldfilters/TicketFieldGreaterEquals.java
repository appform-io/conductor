...
public class TicketFieldGreaterEquals extends TicketFieldFilter {
    Comparable<?> value;
    @Jacksonized
    @Builder
    public TicketFieldGreaterEquals(String fieldSchemaId, Comparable<?> value) {
        super(TicketFieldFilterType.GREATER_EQUALS, fieldSchemaId);
        this.value = value;
    }
