...
package io.appform.conductor.console.ui.views.user;
...
public class UserAccountView extends BaseLoggedInView {
    User userDetails;

    public UserAccountView(User currentUser, User userDetails) {
        super("templates/user/user-account.hbs",
              currentUser,
